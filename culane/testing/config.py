...
# globel param
# dataset setting
img_width = 256 #can be taken the square root of it
img_height = 128
patch_size=16
mask_ratio=0.5
img_channel = 3
...
label_height = 128
label_channel = 1
data_loader_numworkers = 2 #8
#path
train_path = "./data/train_index_4000.txt"# same dataset as pretain
val_path = "./data/val_index_800.txt"# same dataset as preval
...
pretrained_path='./model_pretrain/epoch1_valloss0.0039887395687401295_RAdam_0.001.pth'
...
def args_setting():
    ...
    parser.add_argument('--batch-size', type=int, default=4, metavar='N',#default=15
